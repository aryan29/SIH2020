...
getUserInformation() async {
  ...
  var res1 = await dio.get("http://0.0.0.0:8000/api/users2/");
  var res2 = await dio.get("http://0.0.0.0:8000/api/users1/");
  var res3 = await dio.get("http://0.0.0.0:8000/api/getcontributions/");
  print(res3.data);
...
getNearbyNGO(var lat, var lon) async {
  ...
  try {
    var res1 =
        await dio.post("http://0.0.0.0:8000/api/ngoslist/", data: formData);
    // print(res1.data);
    return res1.data;
  } on DioError catch (e) {
...
getMyImages() async {
  ...
  var dio = Dio();
  dio.options.headers["Authorization"] = "Token $token";
  var res1 = await dio.get("http://0.0.0.0:8000/api/myimages/");
  print(res1.data);
